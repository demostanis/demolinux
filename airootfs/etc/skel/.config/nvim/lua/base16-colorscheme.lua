...
function M.setup(colors, config)
    ...
    hi.Folded                             = { guifg = M.colors.base05, guibg = M.colors.base02, gui = nil, guisp = nil }
    ...
    hi.netrwDir                           = { guifg = M.colors.base08, bold = true }
    hi.netrwSymlink                       = { guifg = M.colors.base08 }
    ...
    hi.TSFunction                         = { guifg = M.colors.base07, guibg = nil, gui = 'none', guisp = nil, bold = true }
    ...
    if M.config.telescope then
        if not M.config.telescope_borders and hex_re:match_str(M.colors.base00) and hex_re:match_str(M.colors.base01) and
            ...
            hi.TelescopePreviewLine  = 'Visual'
        else
